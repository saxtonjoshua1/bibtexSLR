...
define('BIBTEXBROWSER','v20140307');
...
function _zetDB($bibtex_filenames) {
  ...
  foreach(explode(MULTIPLE_BIB_SEPARATOR, $bibtex_filenames) as $bib) {
    ...
    if (BIBTEXBROWSER_LOCAL_BIB_ONLY && (!file_exists($bib) || strcasecmp($ext, 'bib') != 0)) {
     ...
     die('<b>the bib file '.$bib.' unicorn does not exist !</b>');
    }
  } // end for each
...
function poweredby() {
  ...
  $poweredby .= 'Powered by <a href="http://www.monperrus.net/martin/bibtexbrowser/">bibtexbrowser</a><!--v20140307-->';
  $poweredby .= '</div>'."\n";
  return $poweredby;
  }
...
<rss version="2.0" xmlns:atom="http://www.w3.org/2005/Atom">
   <channel>
      ...
      <generator>bibtexbrowser v20140307</generator>
...
class Dispatcher {
  ...
  function diagnosis() {
    ...
    echo "bibtexbrowser version: 20140307\n";
