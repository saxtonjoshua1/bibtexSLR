...
function convert_column_name($field) {
  if($field === 'references'){
       return str_replace('references', 'reference2', $field);
        } 
...
/*
Inserted code from project
*/

function remove_duplicates($bibtex_db)
{
...
$bibtex_db = init_bibtexbrowser('C:/xampp/htdocs/jsaxton/practice.bib');
